...
import com.mind.recipereview.exceptionhandling.UserNotFoundException;
@RestControllerAdvice
public class UserExceptionHandler 
{
	@ExceptionHandler
	public ResponseEntity<ErrorResponce>handleExcption(UserNotFoundException exception){
